...
# Ejemplo:
# ./python2 cin_dir_4.py 10 0 0 0 10 10
...
# Parámetros D-H:
#        1    1`   2       3    4    4¹    4²   5¹  5²    6¹    6²       EF   
d  = [p[0],   0,   0,      0,   5,   0,    0,   1,  1, p[5], p[5],  1+p[5]]
th = [   0,   0,p[1],90+p[2],p[3],   0,    0,   0,  1,    0,    0,       0]
a  = [   0,   2,   2,      0,   0,p[4],-p[4],   0,  0,    0,    0,       0]
al = [  90, -90,  90,     90,   0,   0,    0,   0,  0,    0,    0,       0]
...
T11prima=matriz_T(d[1],th[1],a[1],al[1])
T01prima=np.dot(T01,T11prima)

T1prima2=matriz_T(d[2],th[2],a[2],al[2])
T02=np.dot(T01prima,T1prima2)
...
o110 =np.dot(T01prima, o1111).tolist()
...
muestra_origenes([o00,o10, o110,o20,o30,o40,[[o410,o510, o610], [o420,o520, o620]]] ,oEF0)
muestra_robot   ([o00,o10, o110,o20,o30,o40,[[o410,o510, o610], [o420,o520, o620]]], oEF0)
input()
